...
import at.c02.tempus.datamodels.StateResult;
import at.c02.tempus.utils.RecyclerAdapter;
...
public class StateListActivity extends AppCompatActivity {
    @BindView(at.c02.tempus.R.id.stateRecyclerView)
    ...
    @BindView(at.c02.tempus.R.id.toolbar)
    Toolbar toolbar;
    @BindView(at.c02.tempus.R.id.toolbar_title)
    TextView toolBarTitle;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(at.c02.tempus.R.layout.activity_state_list);
